...
model = dict(
    type='RetinaNet',
    pretrained='/home/bearbee/basemodels/shufflenetv2/shufflenetv2_x0.5.pth',
    backbone=dict(
        type='ShuffleNetV2',
...
log_level = 'INFO'
work_dir = '/home/bearbee/work_dirs/dac_competition/retinanet_shufflenetv2_x0_5_fpn_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]

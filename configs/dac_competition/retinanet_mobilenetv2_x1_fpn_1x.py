...
model = dict(
    type='RetinaNet',
    pretrained='/home/bearbee/basemodels/mobilenetv2/mobilenet_v2-b0353104.pth',
    backbone=dict(
        type='MobileNetV2',
        width_mult=1,
        freeze_conv_at=2),
...
log_level = 'INFO'
work_dir = '/home/bearbee/work_dirs/dac_competition/retinanet_mobilenetv2_x1_fpn_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]

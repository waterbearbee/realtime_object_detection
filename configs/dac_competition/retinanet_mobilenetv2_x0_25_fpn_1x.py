...
model = dict(
    type='RetinaNet',
    pretrained='/home/xiongfeng/basemodels/mobilenetv2/mobilenetv2_0.25-b61d2159.pth',
    backbone=dict(
        type='MobileNetV2',
        width_mult=0.25,
        freeze_conv_at=2),
...
log_level = 'INFO'
work_dir = '/home/xiongfeng/work_dirs/dac_competition/retinanet_mobilenetv2_x0_25_fpn_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
